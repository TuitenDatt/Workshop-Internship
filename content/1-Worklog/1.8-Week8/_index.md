...
* Set up an automated monitoring and alerting system for cloud infrastructure and prepare the foundation for the main project.
...
* Completed business analysis and clarified the automated operational flow of the Rental VM project.
* Successfully designed the detailed Database structure and completed an optimized AWS infrastructure architecture diagram.
* Successfully set up a shared working environment and standardized the source code development process.
