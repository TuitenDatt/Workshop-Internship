...
* Build and successfully deploy a REST API Backend system using a lightweight Serverless architecture (API Gateway + Lambda + DynamoDB).
...
* Developed software using a lightweight Serverless model that optimizes resources.
* Successfully built a complete REST API using the trio of API Gateway, Lambda, and DynamoDB.
* Learned how to debug and monitor the operation of serverless functions through the console.
